...
export default class Home extends Component {
  ...
  filterData(posts, searchKey) {
    ...
    const result = posts.filter((post) =>
      ...
      post.come.toLowerCase().includes(searchKey) ||
      post.leave.toLowerCase().includes(searchKey) ||
      post.name.toUpperCase().includes(searchKey) ||
      post.email.toUpperCase().includes(searchKey) ||
      post.date.toUpperCase().includes(searchKey) ||
      post.come.toUpperCase().includes(searchKey) ||
      post.leave.toUpperCase().includes(searchKey) 
    )
