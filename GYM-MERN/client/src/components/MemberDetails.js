...
export default class Home extends Component {
  ...
  filterData(posts, searchKey) {
    ...
    const result = posts.filter((post) =>
      ...
      post.height.toLowerCase().includes(searchKey) ||
      post.weight.toLowerCase().includes(searchKey) ||
      post.payment_status.toLowerCase().includes(searchKey) ||
      post.name.toUpperCase().includes(searchKey) ||
      post.email.toUpperCase().includes(searchKey) ||
      post.address.toUpperCase().includes(searchKey) ||
      post.age.toUpperCase().includes(searchKey) ||
      post.height.toUpperCase().includes(searchKey) ||
      post.weight.toUpperCase().includes(searchKey) ||
      post.payment_status.toUpperCase().includes(searchKey) 
    )
